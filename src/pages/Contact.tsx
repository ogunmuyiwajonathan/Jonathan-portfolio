            ...
            <div className="max-[900px]:order-2 max-[900px]:mt-[20px]">
                ...
                <div className="mt-[40px]">
                    ...
                    <div className="flex gap-[12px] mt-[20px]">
                        ...
                        <a href="https://linkedin.com/in/ogunmuyiwajonathan" target="_blank" rel="noopener noreferrer" className="w-[48px] h-[48px] border border-border-color rounded-full flex items-center justify-center transition-all duration-300 bg-[#161616] text-white no-underline hover:bg-[#0077b5] hover:text-white hover:border-[#0077b5] hover:-translate-y-[5px]" title="LinkedIn">
                            <Linkedin size={20} />
                        </a>
                        <a href="https://twitter.com/ogunmuyiwajonathan" target="_blank" rel="noopener noreferrer" className="w-[48px] h-[48px] border border-border-color rounded-full flex items-center justify-center transition-all duration-300 bg-[#161616] text-white no-underline hover:bg-white hover:text-black hover:-translate-y-[5px]" title="Twitter/X">
                ...
                <form className="flex flex-col gap-[20px]" onSubmit={handleSubmit}>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            disabled={formStatus.state === 'submitting'}
                            className={`
                                w-full bg-[#1d1d1d] border rounded-[12px] p-[16px_20px] text-[0.95rem] transition-all duration-300 font-inherit focus:outline-none focus:bg-[#222] cursor-pointer appearance-none
